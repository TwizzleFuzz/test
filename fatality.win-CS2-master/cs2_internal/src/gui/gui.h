...
namespace evo::gui
{
	...
	struct color_list
	{
		MAKE_COLOR(accent, 235, 5, 90);
		MAKE_COLOR(text, 245, 245, 245);
		MAKE_COLOR(text_light, 245, 245, 245);
		MAKE_COLOR(text_mid, 109, 100, 150);
		MAKE_COLOR(text_dark, 109, 100, 150);
		MAKE_COLOR(bg_bottom, 17, 15, 35);
		MAKE_COLOR(bg_block, 25, 21, 52);
		MAKE_COLOR(bg_block_overlay, 33, 27, 69);
		MAKE_COLOR(bg_block_light, 33, 27, 69);
		MAKE_COLOR(bg_odd, 25, 21, 52);
		MAKE_COLOR(bg_even, 25, 21, 52);
		MAKE_COLOR(outline, 60, 53, 93);
		MAKE_COLOR(outline_light, 60, 53, 93);
